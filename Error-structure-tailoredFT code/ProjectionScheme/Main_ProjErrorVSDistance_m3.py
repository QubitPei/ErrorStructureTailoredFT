...
Output_Filename = 'MainProjScale251216m3.pkl'   #!!! name of the output data file
...
def main():
    ...
    for id, k in enumerate(k_List):
        ...
        Tr_Dist, P_fail = util.Trace_distace_estimate_m3(phi = phi, z_distance = z_distance, 
    ...
    # Save the plot
    plt.savefig('Projection_ErrorScale_251216_m3.eps', format='eps', dpi=1000, bbox_inches='tight')
